...
Write-Host "test"
			$SyncHash.textBlock.Dispatcher.Invoke([action]{$global:test = $SyncHash.textBlock.text},"Normal")
			Write-Host "$test"
			$SyncHash.Results.
			$SyncHash.textBlock.Dispatcher.Invoke([action]{$SyncHash.textBlock.text="test"},"Normal")
