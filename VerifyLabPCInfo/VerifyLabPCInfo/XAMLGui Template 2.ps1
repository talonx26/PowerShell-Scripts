...
$psCmd = [PowerShell]::Create().AddScript({
   ...
   <Window 
        ...
        xmlns:local="clr-namespace:WSUSInstallMonitor"
        mc:Ignorable="d"
        Title="Window1" Height="353.133" Width="634.333">
    <Grid Margin="0,0,-185.2,-18.6" RenderTransformOrigin="0.338,0.361">

        <DataGrid x:Name="dataGrid" HorizontalAlignment="Left" Margin="0,10,0,0" VerticalAlignment="Top" Height="266" Width="547" Grid.ColumnSpan="2" Grid.Row="1" Grid.RowSpan="2">
            <DataGrid.Columns>
                <DataGridTextColumn Binding="{Binding Computer}"  Header="Source"/>
                <DataGridTextColumn Binding="{Binding Action}" Header="IP Address" SortMemberPath="IP Address"/>
                <DataGridTextColumn Binding="{Binding Time}" Header="HostName" SortMemberPath="HostName"/>
            </DataGrid.Columns>
